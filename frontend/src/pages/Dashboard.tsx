        ...
        <div className="p-8">
          ...
          <nav className="space-y-2">
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl font-medium transition-all group cursor-pointer border ${filter === 'all'
                ? 'bg-white/10 text-white hover:bg-white/20 border-white/5 shadow-sm'
                : 'text-violet-100 hover:bg-white/10 hover:text-white border-transparent'
                }`}
            >
